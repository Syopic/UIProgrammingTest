package  
{
	...
	import ua.com.syo.uitest.components.Category;
	...
	import ua.com.syo.uitest.components.Subcategory;
	...
	public class UIProgrammingTest extends Sprite
	{
		...
		private function init(event:Event = null):void 
		{
			...
			var accordion:Accordion = new Accordion(panel, 0, 0);
			accordion.width = 200;
			
			
			var category1:Category = new Category(null, 0, 0, "Test Category1", new Array("Item1", "Item2", "Item3", "Item4", "Item3", "Item4"));
			accordion.addCategory(category1, 0);
			
			var category2:Category = new Category(null, 0, 0, "Test Category2", new Array("Item1", "Item2", "Item3"));
			accordion.addCategory(category2, 1);
			
			var category3:Category = new Category(null, 0, 0, "Test Category3", new Array("Item1", "Item2"));
			accordion.addCategory(category3, 2);
			
			var category4:Category = new Category(null, 0, 0, "Test Category4", new Array("Item1", "Item2", "Item3", "Item4", "Item3", "Item4"));
